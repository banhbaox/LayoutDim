...
#ifndef _G_BASIC_STRING_H_
#define _G_BASIC_STRING_H_

#include <string>

#include "GeMS/dcl_gems.h"

#include "GeMS/StringUtil.h"
#include "GeMS/Utility/GMemory.h"

DECL_GEMS unsigned int g_set_a2w_code_page(unsigned int unCP);
DECL_GEMS std::wstring GStdA2WHelper(const std::string &pa);
DECL_GEMS std::wstring GStdA2WHelper(const char *pa, size_t nChars);
